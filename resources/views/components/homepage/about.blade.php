                ...
                <div class="flex items-center -mx-3 sm:-mx-4">
                    <div class="w-full px-3 xl:w-1/2 sm:px-4">
                        <div class="py-3 sm:py-4">
                            <img src="{{ asset('img/sorghum_field.jpg') }}" alt="" class="w-full rounded-2xl" />
                        </div>
                        <div class="py-3 sm:py-4">
                            <img src="{{ asset('img/tractor.jpg') }}" alt="" class="w-full rounded-2xl" />
                        </div>
                    </div>
                    <div class="w-full px-3 xl:w-1/2 sm:px-4">
                        <div class="relative z-10 my-4">
                            <img src="{{ asset('img/farm-software.jpg') }}" alt="" class="w-full rounded-2xl" />
            ...
            <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                <div class="mt-10 lg:mt-0">
                    ...
                    <h2 class="mb-8 text-3xl font-bold sm:text-4xl text-dark">
                        Linking farm services for agri-business productivity.
                    </h2>
                    <p class="mb-8 text-base text-body-color">
                        It is a long established fact that a reader that agriculture is the hidden gold mine for all
                        times because humans and animals must eat to survive. It is our goal to ensure farms
                        productivity and profitability.
                    </p>
                    <p class="mb-12 text-base text-body-color">
                        Agrican Nigeria Limited is an Agro-Commodity Trading and Farm Management Company which
                        specialises in domestic and international supply of agricultural products such as Cashew nuts,
                        Sesame, ginger, sorghum, etc. and Digital Extension & Book keeping Services that help improve
